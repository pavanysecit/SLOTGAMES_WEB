...
public class TreasureBonanza_Web_PayOut_BetType_2_And_Denomination_All {
	WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_click_on_back_button_select_bet_type_as_denomination_values_like_and_check_payout_amount(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) throws Throwable {
		...
		Pattern denomination1=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_2_1.png");
		Pattern denomination2=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_2_2.png");
		Pattern denomination3=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_2_3.png");
		Pattern denomination4=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_2_4.png");
		Pattern denomination5=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_2_5.png");
	     
		//comparing the credit value should be 0.02
		screen.click(plus);
		Thread.sleep(2000);
	    Pattern credit1=new Pattern("E:/Sikuli Images/TreasureBonanza/creditvalue_2.png");
		...
		Thread.sleep(2000);
         ...
         Pattern pat1=new Pattern("E:/Sikuli Images/TreasureBonanza/payout2_1.png");
         ...
         Pattern pat2=new Pattern("E:/Sikuli Images/TreasureBonanza/payout2_2.png");
         ...
         Pattern pat3=new Pattern("E:/Sikuli Images/TreasureBonanza/payout2_3.png");
        ...
        Pattern pat4=new Pattern("E:/Sikuli Images/TreasureBonanza/payout2_4.png");
        ...
        Pattern pat5=new Pattern("E:/Sikuli Images/TreasureBonanza/payout2_5.png");
	...
	@Then("^System should display the Payout max amount on each symbol and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and denomination values like (\\d+)\\.(\\d+), (\\d+)\\.(\\d+), (\\d+), (\\d+) & (\\d+) in Treasure Bonanza slot game on Web$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_denomination_values_like_in_Treasure_Bonanza_slot_game_on_Web(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) throws Throwable {
		 Thread.sleep(3000);
		 driver.quit();
	}
}
