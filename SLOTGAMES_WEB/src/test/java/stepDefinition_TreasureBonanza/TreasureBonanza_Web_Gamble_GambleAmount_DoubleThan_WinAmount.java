...
public class TreasureBonanza_Web_Gamble_GambleAmount_DoubleThan_WinAmount {
WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_to_win_amount() throws Throwable {
		...
		Pattern status=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win_amount.png");
		 ...
		 //comparing the win amount should exists after spin
	      ...
	      Pattern winB=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_colorwin.PNG");
		  ...
		  System.out.println("Color Win amount comparision completed successfully. Gamble Win amount is 5.00 YSI");
		  finder3.destroy();  
		  }         
		  else    
		  { 
	      ...
	      Pattern winBB=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_suitwin.PNG");
		  ...
		  System.out.println("Gamble 4x Win amount comparision completed successfully. Gamble Win amount is 10.00 YSI");
		  finder33.destroy();  
		  }         
		  else    
		  { 
