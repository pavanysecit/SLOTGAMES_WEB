...
public class TreasureBonanza_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value2 {
	WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_the_dinomination_drop_down_value_two_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern betvalue_2_3=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_2_3.png");
		...
		Pattern balanceCr=new Pattern("E:/Sikuli Images/TreasureBonanza/balance_credits2_2.png");
		Pattern wincr=new Pattern("E:/Sikuli Images/TreasureBonanza/balance_click.png");
		 ...
		 screen.click(betvalue_2_3);
		 Thread.sleep(2000);
		 screen.click(spin);
		 Thread.sleep(5000);
		 
		 //comparing the win amount should exists after spin
	      Pattern winA=new Pattern("E:/Sikuli Images/TreasureBonanza/win_amount1.PNG");
		  ...
		  System.out.println("Win amount comparision after spin completed successfully. Win amount is 5.00");
		  finder2.destroy();  
		  }         
		  else    
		  { 
	      ...
	      Pattern balanceA=new Pattern("E:/Sikuli Images/TreasureBonanza/winamount_credits.PNG");
		  ...
		  //Balance in credits 
	      Pattern symbol=new Pattern("E:/Sikuli Images/TreasureBonanza/balance_credits2_2.PNG");
	      ...
	      Pattern winB=new Pattern("E:/Sikuli Images/TreasureBonanza/win_amount1.PNG");
