...
public class TreasureBonanza_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_4 {
	WebDriver driver;
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_transfer_the_amount_select_bet_type_as_denomination_as_TWO_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2) throws Throwable {
		...
		Pattern betvalue_1_4=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_1_4.png");
		...
		Thread.sleep(2000);
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win1_111.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win2_111.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win3_111.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win4_111.PNG");
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win5_111.PNG");
		 ...
		 System.out.println("If the win amount is 68.00, gamble count should be 1.");
		 finder123.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win6_111.PNG");
		 ...
		 System.out.println("If the win amount is exceeds 128.00 YSI, gamble link should be disabled.");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
