...
public class TreasureBonanza_Web_Gamble_WinAmount_SameAs_GambleAmount {
WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_amount() throws Throwable {
		...
		Pattern status=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win_amount.png");
		 ...
		 //comparing the Gamble win amount should be same as win amount
	      Pattern winB=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win_amount.PNG");
		  ...
		  System.out.println("Gamble Win amount comparision completed successfully. Gamble Win amount is 2.50 YSI");
		  finder3.destroy();  
		  }         
		  else    
		  { 
