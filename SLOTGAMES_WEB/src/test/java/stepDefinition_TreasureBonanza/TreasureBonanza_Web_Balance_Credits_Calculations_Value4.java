...
public class TreasureBonanza_Web_Balance_Credits_Calculations_Value4 {
	WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_multiply_credit_by_denomination_manually_with_and_check_the_balance(int arg1, int arg2) throws Throwable {
		...
		//comparing the balance before converting into credits
		  ...
		  screen.click(plus);
		  Thread.sleep(2000);
	      Pattern cred=new Pattern("E:/Sikuli Images/TreasureBonanza/creditvalue_4.PNG");
		 ...
		 //comparing the balance in credit
	      Pattern winA=new Pattern("E:/Sikuli Images/TreasureBonanza/balance_credits3.PNG");
