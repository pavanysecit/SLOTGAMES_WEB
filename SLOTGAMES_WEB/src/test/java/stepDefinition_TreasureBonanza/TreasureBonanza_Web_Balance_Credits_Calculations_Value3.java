...
public class TreasureBonanza_Web_Balance_Credits_Calculations_Value3 {
	WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_multiply_credit_by_and_compare_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern creditC=new Pattern("E:/Sikuli Images/TreasureBonanza/balance_credits3.png");
		...
		//comparing the balance before converting into credits
		  ...
		  screen.click(plus);
		  Thread.sleep(2000);
	      Pattern cred=new Pattern("E:/Sikuli Images/TreasureBonanza/creditvalue_3.PNG");
		 ...
		 //comparing the balance in credit
	      Pattern winA=new Pattern("E:/Sikuli Images/TreasureBonanza/balance_credits2.PNG");
