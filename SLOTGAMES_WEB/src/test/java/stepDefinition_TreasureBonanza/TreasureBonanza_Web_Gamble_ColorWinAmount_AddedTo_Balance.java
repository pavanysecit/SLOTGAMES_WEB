...
public class TreasureBonanza_Web_Gamble_ColorWinAmount_AddedTo_Balance {
	WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_button_and_check_the_balance_after_win() throws Throwable {
		...
		Pattern red=new Pattern("E:/Sikuli Images/TreasureBonanza/red.png");
		 ...
		 //comparing the win amount should exists after spin
		  ...
		  if  (screen.exists("E:/Sikuli Images/TreasureBonanza/gamble_win.png") != null)
	      {
			  ...
			  Pattern bal=new Pattern("E:/Sikuli Images/TreasureBonanza/balance_afterwin.PNG");
			  ...
			  System.out.println("Gamable Win amount added to the balance. Balance is 304.00 YSI. ");
			  finder6.destroy();  
			  }         
			  else    
			  { 
