...
public class TreasureBonanza_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_5 {
WebDriver driver;
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_FOUR_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2) throws Throwable {
		...
		Thread.sleep(2000);
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win1_1111.PNG");
		 ...
		 System.out.println("If the win amount is 8.00, gamble count should be 5.");
		 finder1.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win2_1111.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win3_1111.PNG");
		 ...
		 System.out.println("If the win amount is 24.00, gamble count should be 3.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win4_1111.PNG");
		 ...
		 System.out.println("If the win amount is 40.00, gamble count should be 2.");
		 finder13.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win5_1111.PNG");
		 ...
		 System.out.println("If the win amount is 136.00, gamble count should be 1.");
		 finder123.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win6_1111.PNG");
		 ...
		 System.out.println("If the win amount is exceeds 256.00 YSI, gamble link should be disabled.");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
	...
	@Then("^Gamble count should be displayed based on win amount and gamble max amount configured on the game info page for bet type (\\d+)\\.(\\d+) & denomination FOUR in Treasure Bonanza game$")
	public void gamble_count_should_be_displayed_based_on_win_amount_and_gamble_max_amount_configured_on_the_game_info_page_for_bet_type_denomination_FOUR_in_Treasure_Bonanza_game(int arg1, int arg2) throws Throwable {
		 Thread.sleep(3000);
		 driver.quit();
	}
}