...
public class TreasureBonanza_Web_Check_WinAmount_Display_AsPer_GoldSymbol {
	WebDriver driver;
	
	@Given("^Chrome browser, valid URL, valid login details, Treasure Bonanza slot game, bet type, denomination as (\\d+)\\.(\\d+) & (\\d+), balance, gold symbols, spin button, win amount, game info page and payout table$")
	public void chrome_browser_valid_URL_valid_login_details_Treasure_Bonanza_slot_game_bet_type_denomination_as_balance_gold_symbols_spin_button_win_amount_game_info_page_and_payout_table(int arg1, int arg2, int arg3) throws Throwable {
		this.driver =  TreasureBonanza_URL_Login.getDriver();
	}

	@When("^Open the Treasure Bonanza slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, select bet type & denomination as (\\d+)\\.(\\d+) & (\\d+), click on spin button till player wins, check the gold symbols and its count and navigate to payout table$")
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_denomination_as_click_on_spin_button_till_player_wins_check_the_gold_symbols_and_its_count_and_navigate_to_payout_table(int arg1, int arg2, int arg3) throws Throwable {
		...
		Pattern Win_s_27=new Pattern("E:/Sikuli Images/TreasureBonanza/Win_s_27.png");
		Pattern Win_s_28=new Pattern("E:/Sikuli Images/TreasureBonanza/Win_s_28.png");
		...
		Pattern Win_s_32=new Pattern("E:/Sikuli Images/TreasureBonanza/Win_s_32.png");
		Pattern Win_s_33=new Pattern("E:/Sikuli Images/TreasureBonanza/Win_s_33.png");
		Pattern Win_s_34=new Pattern("E:/Sikuli Images/TreasureBonanza/Win_s_34.png");
		...
		Pattern collect=new Pattern("E:/Sikuli Images/TreasureBonanza/collect.png");
		 ...
		 Thread.sleep(5000);
	      ...
	      Pattern balance=new Pattern("E:/Sikuli Images/TreasureBonanza/5golds_win.PNG");
		  ...
		  System.out.println("If 5 gold symbolsappears on the screen and denomination is 0.2, Win amount should be 3.00.");
		  finder1.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("5 Gold symbols comparision for denomination 0.2: "+" "+score1 +"%");
		 ...
		 //comparing the win amount based on gold symbol
	      Pattern winA=new Pattern("E:/Sikuli Images/TreasureBonanza/4golds_win.PNG");
		  ...
		  System.out.println("If 4 gold symbolsappears on the screen and denomination is 0.2, Win amount should be 0.50.");
		  finder2.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("4 Gold symbols comparision for denomination 0.2: "+" "+score2 +"%");
	      ...
	      Pattern balanceA=new Pattern("E:/Sikuli Images/TreasureBonanza/3golds_win.PNG");
		  ...
		  System.out.println("If 3 gold symbolsappears on the screen and denomination is 0.2, Win amount should be 0.15.");
		  finder3.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("3 Gold symbols comparision for denomination 0.2: "+" "+score3 +"%");
		...
		//clicking on collect button
		 ...
		 Thread.sleep(5000);
		  ...
		  //comparing the balance amount after win
	      Pattern balanceAA=new Pattern("E:/Sikuli Images/TreasureBonanza/5golds_win_1.PNG");
		  ...
		  System.out.println("If 5 gold symbols appears on the screen and denomination is 4, Win amount should be 60.00.");
		  finder31.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("5 Gold symbols comparision for denomination 4: "+" "+score31 +"%");
		 ...
		 //comparing the win amount based on gold symbol
	      Pattern winAB=new Pattern("E:/Sikuli Images/TreasureBonanza/4golds_win_1.PNG");
		  ...
		  System.out.println("If 4 gold symbols appears on the screen and denomination is 4, Win amount should be 10.00.");
		  finder21.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("4 Gold symbols comparision for denomination 4: "+" "+score21 +"%");
		  ...
		  //comparing the balance amount after win
	      Pattern balanceAC=new Pattern("E:/Sikuli Images/TreasureBonanza/3golds_win_1.PNG");
		  ...
		  System.out.println("If 3 gold symbolsappears on the screen and denomination is 4, Win amount should be 3.00.");
		  finder32.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("3 Gold symbols comparision for denomination 4: "+" "+score32 +"%");
	...
	public void win_amount_should_be_displayed_based_on_gold_symbols_its_occurance_and_should_be_same_as_amount_configured_on_the_payout_table_in_Treasure_Bonanza_game() throws Throwable {
		 Thread.sleep(3000);
		 driver.quit();
	}
}
