...
public class TreasureBonanza_Web_Check_MaximizeAndMinimize_Buttons {
	WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_maximize_button_and_click_on_minimize_button() throws Throwable {
		...
		Pattern url=new Pattern("E:/Sikuli Images/TreasureBonanza/url.png");
		Pattern min=new Pattern("E:/Sikuli Images/TreasureBonanza/minimize.png");
		Pattern max=new Pattern("E:/Sikuli Images/TreasureBonanza/maximize.png");
		...
		//Clicking on setting icon and then clicking on maximize icon 
		 ...
		 Thread.sleep(6000);
	      ...
	      Pattern credit1=new Pattern("E:/Sikuli Images/TreasureBonanza/url.png");
		 ...
		 Thread.sleep(5000);
	      ...
	      Pattern winA=new Pattern("E:/Sikuli Images/TreasureBonanza/url.PNG");
