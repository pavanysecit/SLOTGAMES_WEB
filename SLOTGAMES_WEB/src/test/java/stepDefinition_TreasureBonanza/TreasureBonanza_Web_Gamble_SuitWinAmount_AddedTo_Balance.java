...
public class TreasureBonanza_Web_Gamble_SuitWinAmount_AddedTo_Balance {
	WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_player_wins_click_on_gamble_button_and_click_on_suit_win_card_in_gamble_page() throws Throwable {
		...
		Pattern pat1=new Pattern("E:/Sikuli Images/TreasureBonanza/balance.PNG");
		...
		Pattern win=new Pattern("E:/Sikuli Images/TreasureBonanza/win_amount4.png");
		Pattern gamble=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble.png");
		Pattern suiticon=new Pattern("E:/Sikuli Images/TreasureBonanza/suiticon.png");
	
		  
		  //comparing the balance before Win
	      Pattern balance=new Pattern("E:/Sikuli Images/TreasureBonanza/balance.PNG");
		 ...
		 //comparing the win amount should exists after spin
	      Pattern winA=new Pattern("E:/Sikuli Images/TreasureBonanza/win_amount.PNG");
		  ...
		  System.out.println("Win amount comparision completed successfully. Win amount is 2.50 YSI");
		  finder2.destroy();  
		  }         
		  else    
		  { 
	      ...
	      Pattern winAA=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_suitwin.PNG");
		  ...
		  System.out.println("Win amount comparision completed successfully. Win amount is 10.00 YSI");
		  finder12.destroy();  
		  }         
		  else    
		  { 
		  ...
		  if  (screen.exists("E:/Sikuli Images/TreasureBonanza/gamble_win.png") != null)
	      {
	    	  Pattern gambleStatus=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win.PNG");
			  ...
			  Pattern bal=new Pattern("E:/Sikuli Images/TreasureBonanza/balance_aftersuitwin.PNG");
	      ...
	      {		  
			  Pattern Abalance=new Pattern("E:/Sikuli Images/TreasureBonanza/balance_aftergamblelose.PNG");
