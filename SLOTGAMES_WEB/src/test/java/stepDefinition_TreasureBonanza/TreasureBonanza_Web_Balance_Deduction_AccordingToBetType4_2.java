...
public class TreasureBonanza_Web_Balance_Deduction_AccordingToBetType4_2 {
	WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_bet_value_as_twenty_click_on_spin_button_and_check_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern pat1=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_4_2.png");
	  ...
	  //clicking on Bet VALUE
       ...
       Thread.sleep(6000);
	      ...
	      Pattern pat=new Pattern("E:/Sikuli Images/TreasureBonanza/balance4_2.png");
