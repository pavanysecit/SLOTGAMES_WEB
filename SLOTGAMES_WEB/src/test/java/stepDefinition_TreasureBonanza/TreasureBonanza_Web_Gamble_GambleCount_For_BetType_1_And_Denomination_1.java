...
public class TreasureBonanza_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_1 {
	WebDriver driver;
	...
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_as_denomination_as_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		Pattern gcollect=new Pattern("E:/Sikuli Images/TreasureBonanza/collect.png");
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win1.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win2.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win3.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win4.PNG");
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win5.PNG");
		 ...
		 System.out.println("If the win amount is 6.80, gamble count should be 1.");
		 finder123.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/TreasureBonanza/gamble_win6.PNG");
		 ...
		 System.out.println("If the win amount is exceeds 12.80 YSI, gamble link should be disabled.");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
