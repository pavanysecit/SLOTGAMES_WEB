...
public class TreasureBonanza_Web_PayOut_BetType_4_And_Denomination_All {
	WebDriver driver;
	
	@Given("^Chrome browser, valid URL, valid login details, Treasure Bonanza slot game, icon to open payout table, all symbols, max amount on each symbol like A, Wild n etc, back button, bet type (\\d+)\\.(\\d+) and denomination values like (\\d+), (\\d+), (\\d+), (\\d+) & (\\d+) on web$")
	public void chrome_browser_valid_URL_valid_login_details_Treasure_Bonanza_slot_game_icon_to_open_payout_table_all_symbols_max_amount_on_each_symbol_like_A_Wild_n_etc_back_button_bet_type_and_denomination_values_like_on_web(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) throws Throwable {
		this.driver =  TreasureBonanza_URL_Login.getDriver();
	}

	@When("^Open the Treasure Bonanza slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol like A, Wild n etc, click on back button, select bet type as (\\d+)\\.(\\d+) & denomination  values like (\\d+), (\\d+), (\\d+), (\\d+) & (\\d+) and check payout amount on web$")
	public void open_the_Treasure_Bonanza_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_like_A_Wild_n_etc_click_on_back_button_select_bet_type_as_denomination_values_like_and_check_payout_amount_on_web(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) throws Throwable {
		...
		Pattern denomination1=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_4_1.png");
		Pattern denomination2=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_4_2.png");
		Pattern denomination3=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_4_3.png");
		Pattern denomination4=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_4_4.png");
		Pattern denomination5=new Pattern("E:/Sikuli Images/TreasureBonanza/betvalue_4_5.png");
		...
		Thread.sleep(2000);
         ...
         Pattern pat1=new Pattern("E:/Sikuli Images/TreasureBonanza/payout4_1.png");
         ...
         Pattern pat2=new Pattern("E:/Sikuli Images/TreasureBonanza/payout4_2.png");
         ...
         Pattern pat3=new Pattern("E:/Sikuli Images/TreasureBonanza/payout4_3.png");
        ...
        Pattern pat4=new Pattern("E:/Sikuli Images/TreasureBonanza/payout4_4.png");
        ...
        Pattern pat5=new Pattern("E:/Sikuli Images/TreasureBonanza/payout4_5.png");
	...
	@Then("^System should display the Payout max amount on each symbol like A, Wild n etc and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and denomination values like (\\d+), (\\d+), (\\d+), (\\d+) & (\\d+) in Treasure Bonanza slot game on web$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_like_A_Wild_n_etc_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_denomination_values_like_in_Treasure_Bonanza_slot_game_on_web(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) throws Throwable {
		 Thread.sleep(3000);
		 driver.quit();
	}
}
