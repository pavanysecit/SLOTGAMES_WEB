...
public class TikeIsle_Web_AutoSpin_TenSpins {
	WebDriver driver;
	
	@Given("^Chrome browser, valid URL, valid login details, Tike Isle  slot game, balance, spin button, auto spin button, ten spins option and number of spins left message$")
	public void chrome_browser_valid_URL_valid_login_details_Tike_Isle_slot_game_balance_spin_button_auto_spin_button_ten_spins_option_and_number_of_spins_left_message() throws Throwable {
		this.driver =  TikeIsle_Web_URL_Login.getDriver();
	}

	@When("^Open the Tike Isle  slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on ten spin option under auto spin drop down and check the number of spins left message$")
	public void open_the_Tike_Isle_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_ten_spin_option_under_auto_spin_drop_down_and_check_the_number_of_spins_left_message() throws Throwable {
		...
		Pattern autoicon=new Pattern("E:/Sikuli Images/Tiki Isle/autospin.png");
		Pattern autospin_20=new Pattern("E:/Sikuli Images/Tiki Isle/autospin_10.png");
		Pattern pat2=new Pattern("E:/Sikuli Images/Tiki Isle/9spins.png");
		Pattern pat3=new Pattern("E:/Sikuli Images/Tiki Isle/8spins.png");
		Pattern pat4=new Pattern("E:/Sikuli Images/Tiki Isle/7spins.png");
		Pattern pat5=new Pattern("E:/Sikuli Images/Tiki Isle/6spins.png");
		Pattern pat6=new Pattern("E:/Sikuli Images/Tiki Isle/5spins.png");
		Pattern pat7=new Pattern("E:/Sikuli Images/Tiki Isle/4spins.png");
		Pattern pat8=new Pattern("E:/Sikuli Images/Tiki Isle/3spins.png");
		Pattern pat9=new Pattern("E:/Sikuli Images/Tiki Isle/2spins.png");
		Pattern pat10=new Pattern("E:/Sikuli Images/Tiki Isle/1spins.png");
		Pattern pat11=new Pattern("E:/Sikuli Images/Tiki Isle/lastspin.png");
		...
		Thread.sleep(1000);
	      ...
	      Pattern credit1=new Pattern("E:/Sikuli Images/Tiki Isle/9spins.png");
	      screen.wait(pat2, 5);
         ...
         Pattern pat=new Pattern("E:/Sikuli Images/Tiki Isle/8spins.png");
         screen.wait(pat3, 5);
		...
		//comparing the number of 7spins left message
         Pattern pat33=new Pattern("E:/Sikuli Images/Tiki Isle/7spins.png");
         screen.wait(pat4, 5);
         ...
         Pattern pat44=new Pattern("E:/Sikuli Images/Tiki Isle/6spins.png");
         screen.wait(pat5, 5);
         ...
         Pattern pat55=new Pattern("E:/Sikuli Images/Tiki Isle/5spins.png");
         screen.wait(pat6, 5);
         ...
         Pattern pat66=new Pattern("E:/Sikuli Images/Tiki Isle/4spins.png");
         screen.wait(pat7, 5);
         ...
         Pattern pat77=new Pattern("E:/Sikuli Images/Tiki Isle/3spins.png");
         screen.wait(pat8, 5);
         ...
         Pattern pat88=new Pattern("E:/Sikuli Images/Tiki Isle/2spins.png");
         screen.wait(pat9, 5);
         Finder finder7 =new Finder(screen.capture().getImage());
         String ht7 = finder7.find(pat88);
         double score7=20;                
         ...
         Pattern pat99=new Pattern("E:/Sikuli Images/Tiki Isle/1spins.png");
         screen.wait(pat10, 5);
         Finder finder8 =new Finder(screen.capture().getImage());
         String ht8 = finder8.find(pat99);
         double score8=20;                
         ...
         Pattern pat100=new Pattern("E:/Sikuli Images/Tiki Isle/lastspin.png");
         screen.wait(pat11, 15);
         Finder finder9 =new Finder(screen.capture().getImage());
         String ht9 = finder9.find(pat100);
         double score9=20;                
	...
	@Then("^Number of spin left should start from (\\d+) to (\\d+) after clicking ten spins option and should perform (\\d+) spins from (\\d+) to (\\d+) in Tike Isle slot game$")
	public void number_of_spin_left_should_start_from_to_after_clicking_ten_spins_option_and_should_perform_spins_from_to_in_Tike_Isle_slot_game(int arg1, int arg2, int arg3, int arg4, int arg5) throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
