...
public class TikeIsle_Web_AutoSpin_TwentySpins {
WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Tike_Isle_slot_game_balance_spin_button_auto_spin_button_twenty_spins_option_and_number_of_spins_left_message() throws Throwable {
	...
	public void open_the_Tike_Isle_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_twenty_spin_option_under_auto_spin_drop_down_and_check_the_number_of_spins_left_message() throws Throwable {
		...
		Pattern spin=new Pattern("E:/Sikuli Images/Tiki Isle/autospin_20.png");
		Pattern pat2=new Pattern("E:/Sikuli Images/Tiki Isle/19spins.png");
		Pattern pat3=new Pattern("E:/Sikuli Images/Tiki Isle/18spins.png");
		Pattern pat4=new Pattern("E:/Sikuli Images/Tiki Isle/17spins.png");
		Pattern pat5=new Pattern("E:/Sikuli Images/Tiki Isle/16spins.png");
		Pattern pat6=new Pattern("E:/Sikuli Images/Tiki Isle/15spins.png");
		Pattern pat7=new Pattern("E:/Sikuli Images/Tiki Isle/14spins.png");
		Pattern pat8=new Pattern("E:/Sikuli Images/Tiki Isle/13spins.png");
		Pattern pat9=new Pattern("E:/Sikuli Images/Tiki Isle/12spins.png");
	...
	@Then("^Number of spin left should start from (\\d+) to (\\d+) after clicking twenty spins option and should perform (\\d+) spins from (\\d+) to (\\d+) in Tike Isle slot game$")
	public void number_of_spin_left_should_start_from_to_after_clicking_twenty_spins_option_and_should_perform_spins_from_to_in_Tike_Isle_slot_game(int arg1, int arg2, int arg3, int arg4, int arg5) throws Throwable {
		Thread.sleep(3000);
		driver.quit();
	}
}
