...
public class TikeIsle_Web_Balance_Credits_Calculations_Value4 {
	WebDriver driver;
	
	@Given("^Chrome browser, valid URL, valid login details, Tike Isle slot game, balance, credits and denomination drop down & value as (\\d+)\\.(\\d+)$")
	public void chrome_browser_valid_URL_valid_login_details_Tike_Isle_slot_game_balance_credits_and_denomination_drop_down_value_as(int arg1, int arg2) throws Throwable {
		this.driver =  TikeIsle_Web_URL_Login.getDriver();
	}

	@When("^Open the Tike Isle slot game by entering the valid URL in browser, enter the valid login details, click on balance, multiply credit by denomination (\\d+)\\.(\\d+) manually with and check the balance$")
	public void open_the_Tike_Isle_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_multiply_credit_by_denomination_manually_with_and_check_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern creditC=new Pattern("E:/Sikuli Images/Tiki Isle/credit4_1.PNG");
		...
		//comparing the balance before converting into credits
		 ...
		 Thread.sleep(2000);
	      ...
	      Pattern cred=new Pattern("E:/Sikuli Images/Tiki Isle/creditvalue4.PNG");
		 ...
		 //comparing the balance in credit
	      Pattern winA=new Pattern("E:/Sikuli Images/Tiki Isle/credit4_1.PNG");
	...
	@Then("^Balance amount should be same after multiplying denomination (\\d+)\\.(\\d+) by credit in Tike Isle slot game$")
	public void balance_amount_should_be_same_after_multiplying_denomination_by_credit_in_Tike_Isle_slot_game(int arg1, int arg2) throws Throwable {
	    Thread.sleep(3000);
	    driver.quit();
	}
}
