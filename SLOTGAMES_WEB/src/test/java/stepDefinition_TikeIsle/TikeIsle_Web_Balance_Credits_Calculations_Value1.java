...
public class TikeIsle_Web_Balance_Credits_Calculations_Value1 {
WebDriver driver;
	
	@Given("^Chrome browser, valid URL, valid login details, Tike Isle slot game, balance, credits and denomination as (\\d+)\\.(\\d+)$")
	public void chrome_browser_valid_URL_valid_login_details_Tike_Isle_slot_game_balance_credits_and_denomination_as(int arg1, int arg2) throws Throwable {
		this.driver =  TikeIsle_Web_URL_Login.getDriver();
	}

	@When("^Open the Tike Isle slot game by entering the valid URL in browser, enter the valid login details, click on balance, multiply credit by (\\d+)\\.(\\d+) and check the balance$")
	public void open_the_Tike_Isle_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_multiply_credit_by_and_check_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern credit=new Pattern("E:/Sikuli Images/Tiki Isle/credit1.png");
		Pattern balance=new Pattern("E:/Sikuli Images/Tiki Isle/balance1.png");
		Pattern creditC=new Pattern("E:/Sikuli Images/Tiki Isle/credit1_1.png");
		...
		//comparing the balance before converting into credits
	      ...
	      Pattern cred=new Pattern("E:/Sikuli Images/Tiki Isle/creditvalue1.PNG");
		 ...
		 //comparing the balance in credit
	      Pattern winA=new Pattern("E:/Sikuli Images/Tiki Isle/credit1_1.PNG");
	...
	@Then("^Balance amound should be same as denomination (\\d+)\\.(\\d+) multiplies by credit in Tike Isle slot game$")
	public void balance_amound_should_be_same_as_denomination_multiplies_by_credit_in_Tike_Isle_slot_game(int arg1, int arg2) throws Throwable {
	     Thread.sleep(3000);
	     driver.quit();
	}
}