...
WebDriver driver;
	...
	public void open_the_Golden_Crown_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_click_on_back_button_select_bet_type_as_denomination_values_like_and_check_payout_amount(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) throws Throwable {
		...
		Pattern denomination1=new Pattern("E:/Sikuli Images/payout/betValue2_1.png");
		Pattern denomination2=new Pattern("E:/Sikuli Images/payout/betValue2_2.png");
		Pattern denomination3=new Pattern("E:/Sikuli Images/payout/betValue2_3.png");
		Pattern denomination4=new Pattern("E:/Sikuli Images/payout/betValue2_4.png");
		Pattern denomination5=new Pattern("E:/Sikuli Images/payout/betValue2_5.png");
	     
		//comparing the credit value should be 0.02
		screen.click(creditV);
		Thread.sleep(2000);
	    Pattern credit1=new Pattern("E:/Sikuli Images/payout/creditvalue2.png");
		...
		Thread.sleep(2000);
         ...
         Pattern pat1=new Pattern("E:/Sikuli Images/payout/payout2_1.png");
         ...
         Pattern pat2=new Pattern("E:/Sikuli Images/payout/payout2_2.png");
         ...
         Pattern pat3=new Pattern("E:/Sikuli Images/payout/payout2_3.png");
        ...
        Pattern pat4=new Pattern("E:/Sikuli Images/payout/payout2_4.png");
        ...
        Pattern pat5=new Pattern("E:/Sikuli Images/payout/payout2_5.png");
