	...
	public void open_the_Golden_Crown_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_to_win_amount() throws Throwable {
		...
		Pattern gamble=new Pattern("E:/Sikuli Images/GoldenCrown/gamble.png");
		 ...
		 //comparing the Color win amount should be double than as win amount
	      Pattern winB=new Pattern("E:/Sikuli Images/GoldenCrown/colorwin.PNG");
		  ...
		  System.out.println("Color Win amount comparision completed successfully. Gamble Win amount is 80.00 YSI");
		  finder3.destroy();  
		  }         
		  else    
		  { 
		 ...
		 //comparing the Suit win amount should be double than as color win amount
	    Pattern winC=new Pattern("E:/Sikuli Images/GoldenCrown/suitwin.PNG");
        Finder finder4 =new Finder(screen.capture().getImage());
        String ht4 = finder4.find(winC);
        double score4=20;                
		...
		System.out.println("Color Win amount comparision completed successfully. Gamble Win amount is 160.00 YSI");
		finder4.destroy();  
		}         
		else    
		{ 
		...
		System.out.println("Suit Win amount comparision value equals to: "+" "+score4 +"%");
