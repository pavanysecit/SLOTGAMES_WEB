...
public class GoldenCrown_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value2 {
	WebDriver driver;
	...
	public void open_the_Golden_Crown_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_the_dinomination_drop_down_value_two_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern balanceCr=new Pattern("E:/Sikuli Images/GoldenCrown/balance_credits_2.png");
		Pattern balanceCr1=new Pattern("E:/Sikuli Images/GoldenCrown/credit_balance_2.png");
		Pattern win_1=new Pattern("E:/Sikuli Images/GoldenCrown/win_2.png");
		...
		screen.wait(spin, 30);
		//clicking on + icon to select the credit as 0.02
		screen.click(credit);
		Thread.sleep(2000);
		 ...
		 //comparing the credit value should be 0.02
		  ...
		  System.out.println("Credit value is 0.02 & comparision successful.");
		  finder.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Credit value is 0.02 & comparision value equals to: "+" "+score +"%");
		 ...
		 //comparing the win amount should exists after spin
	      Pattern winA=new Pattern("E:/Sikuli Images/GoldenCrown/win_2.PNG");
		  ...
		  System.out.println("Win amount is 1.60 after spin and comparision completed successfully.");
		  finder2.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Win amount is 1.60 & comparision value equal to: "+" "+score2 +"%");
	      ...
	      Pattern symbol=new Pattern("E:/Sikuli Images/GoldenCrown/credit_balance_2.PNG");
		  ...
		  System.out.println("Balance in credits 14,980 & comparision successfull. ");
		  finder4.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Balance in credits 14,980 & comparision value equal to	: "+" "+score4 +"%");
	      ...
	      Pattern winB=new Pattern("E:/Sikuli Images/GoldenCrown/win_2.PNG");
		  ...
		  System.out.println("Win amount in credits 80 * credit value(0.02) = 1.60 in currnecy & comparision successfull.");
		  finder6.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Win amount in credits 80 * credit value(0.02) = 1.60 in currnecy & comparision value equal to: "+" "+score6 +"%");
