...
public class GoldenCrown_Web_PayOut_BetType_3_And_Denomination_All {
	...
	public void open_the_Golden_Crown_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_like_orange_cherry_n_etc_click_on_back_button_select_bet_type_as_all_denomination_values_and_check_payout_amount_on_web(int arg1, int arg2) throws Throwable {
		...
		Pattern pat1=new Pattern("E:/Sikuli Images/GoldenCrown/payout3_1.png");
		Pattern pat2=new Pattern("E:/Sikuli Images/GoldenCrown/payout3_2.png");
		Pattern pat3=new Pattern("E:/Sikuli Images/GoldenCrown/payout3_3.png");
		Pattern pat4=new Pattern("E:/Sikuli Images/GoldenCrown/payout3_4.png");
		Pattern pat5=new Pattern("E:/Sikuli Images/GoldenCrown/payout3_5.png");
		Pattern spin=new Pattern("E:/Sikuli Images/GoldenCrown/spin.png");
		
		//selecting credit as 0.05
		screen.wait(spin, 30);
		screen.click(credit);
		Thread.sleep(1000);
		screen.click(credit);
	    ...
	    Pattern credit1=new Pattern("E:/Sikuli Images/GoldenCrown/credit3.png");
		...
		System.out.println("Selected credit value is 0.05 & Comparision is successful. Test case passed");
		finder.destroy();  
		}         
		else    
		{ 
		...
		//comparing the bet value should be 1
	    Pattern credit11=new Pattern("E:/Sikuli Images/GoldenCrown/bet3_1.png");
		...
		System.out.println("Selected bet value is 1 & Comparision is successful. Test case passed");
		finder11.destroy();  
		}         
		else    
		{ 
