...
public class GoldenCrown_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value4 {
	...
	public void open_the_Golden_Crown_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_the_dinomination_drop_down_value_four_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern balanceCr=new Pattern("E:/Sikuli Images/GoldenCrown/balance_credits_4.png");
		Pattern balanceCr1=new Pattern("E:/Sikuli Images/GoldenCrown/credit_balance_4.png");
		Pattern win_1=new Pattern("E:/Sikuli Images/GoldenCrown/win_4.png");
		...
		screen.wait(spin, 30);
		//clicking on + icon to select the credit as 0.5
		screen.click(credit);
		Thread.sleep(1000);
		screen.click(credit);
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		 ...
		 //comparing the credit value should be 0.5
		  ...
		  System.out.println("Credit value is 0.5 & comparision successful.");
		  finder.destroy();  
		  }         
		  else    
		  { 
		 ...
		 //comparing the win amount should exists after spin
	      ...
	      Pattern symbol=new Pattern("E:/Sikuli Images/GoldenCrown/credit_balance_4.PNG");
		  ...
		  System.out.println("Balance in credits 580 & comparision successfull. ");
		  finder4.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Balance in credits 580 & comparision value equal to	: "+" "+score4 +"%");
	      ...
	      Pattern winB=new Pattern("E:/Sikuli Images/GoldenCrown/win_4.PNG");
		  ...
		  System.out.println("Win amount in credits 80 * credit value(0.02) = 40.00 in currnecy & comparision successfull.");
		  finder6.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Win amount in credits 80 * credit value(0.01) = 40.00 in currnecy & comparision value equal to: "+" "+score6 +"%");
