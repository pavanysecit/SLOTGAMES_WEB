...
public class GoldenCrown_Web_Gamble_GambleCount_For_BetType_2_And_Denomination_4 {
	WebDriver driver;
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_enter_the_amount_transfer_the_balance_click_on_golden_hot_slot_game_transfer_the_amount_select_bet_type_as_denomination_as_FOUR_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2) throws Throwable {
		...
		Pattern winSyb=new Pattern("E:/Sikuli Images/gamble/betValue2_4.png");
		...
		//Changing the credit value to 0.02
		screen.click(Cicon);
		Thread.sleep(2000);
		
		//Selecting denomination as 4  
		screen.click(winSyb);
		Thread.sleep(2000);
		
		 //Checking the credit value should be 0.02
	     Pattern credit=new Pattern("E:/Sikuli Images/gamble/creditvalue2.PNG");
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/gamble/Win_1_5_1.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/gamble/Win_1_5_2.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/gamble/Win_1_5_3.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/gamble/Win_1_5_4.PNG");
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/gamble/Win_1_5_5.PNG");
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/gamble/Win_1_5_6.PNG");
