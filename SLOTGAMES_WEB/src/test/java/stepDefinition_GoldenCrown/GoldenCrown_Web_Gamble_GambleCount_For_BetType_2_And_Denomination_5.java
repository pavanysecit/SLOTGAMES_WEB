...
public class GoldenCrown_Web_Gamble_GambleCount_For_BetType_2_And_Denomination_5 {
WebDriver driver;
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_EIGHT_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2) throws Throwable {
		...
		Pattern winSyb=new Pattern("E:/Sikuli Images/gamble/betValue2_5.png");
		...
		Thread.sleep(2000);
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/gamble/Win_2_5_1.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/gamble/Win_2_5_2.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/gamble/Win_2_5_3.PNG");
		 ...
		 System.out.println("If the win amount is 48.00, gamble count should be 3.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/gamble/Win_2_5_4.PNG");
		 ...
		 System.out.println("If the win amount is 80.00, gamble count should be 2.");
		 finder13.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/gamble/Win_2_5_5.PNG");
		 ...
		 System.out.println("If the win amount is 224.00, gamble count should be 1.");
		 finder123.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/gamble/Win_2_5_6.PNG");
