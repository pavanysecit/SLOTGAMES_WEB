...
public class GoldenCrown_Web_Gamble_GambleCount_For_BetType_3_And_Denomination_3 {
WebDriver driver;
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_FIVE_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count_in_gamble_page_of_slot_game(int arg1, int arg2) throws Throwable {
		...
		Pattern winSyb=new Pattern("E:/Sikuli Images/gamble/betValue3_3.png");
		...
		Thread.sleep(2000);
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/gamble/Win_3_3_1.PNG");
		 ...
		 System.out.println("If the win amount is 5.00, gamble count should be 5.");
		 finder1.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/gamble/Win_3_3_2.PNG");
		 ...
		 System.out.println("If the win amount is 15.00, gamble count should be 4.");
		 finder11.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/gamble/Win_3_3_3.PNG");
		 ...
		 System.out.println("If the win amount is 30.00, gamble count should be 3.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/gamble/Win_3_3_4.PNG");
		 ...
		 System.out.println("If the win amount is 60.00, gamble count should be 2.");
		 finder13.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/gamble/Win_3_3_5.PNG");
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/gamble/Win_3_3_6.PNG");
