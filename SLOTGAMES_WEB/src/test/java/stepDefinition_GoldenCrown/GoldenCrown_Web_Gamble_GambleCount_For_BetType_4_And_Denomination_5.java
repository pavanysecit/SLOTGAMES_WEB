...
public class GoldenCrown_Web_Gamble_GambleCount_For_BetType_4_And_Denomination_5 {
WebDriver driver;
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2, int arg3) throws Throwable {
		...
		Pattern winSyb=new Pattern("E:/Sikuli Images/gamble/betValue4_5.png");
		...
		//Selecting denomination as 200  
		screen.click(winSyb);
		Thread.sleep(2000);

		
		 //Checking the credit value should be 0.5
	     Pattern credit=new Pattern("E:/Sikuli Images/gamble/creditvalue4.PNG");
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/gamble/Win_4_5_1.PNG");
		 ...
		 System.out.println("If the win amount is 200.00, gamble count should be 5.");
		 finder1.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/gamble/Win_4_5_2.PNG");
		 ...
		 System.out.println("If the win amount is 600.00, gamble count should be 4.");
		 finder11.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/gamble/Win_4_5_3.PNG");
		 ...
		 System.out.println("If the win amount is 1200.00, gamble count should be 3.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/gamble/Win_4_5_4.PNG");
		 ...
		 System.out.println("If the win amount is 2000.00, gamble count should be 2.");
		 finder13.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/gamble/Win_4_5_5.PNG");
		 ...
		 System.out.println("If the win amount is 5600.00, gamble count should be 1.");
		 finder123.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/gamble/Win_4_5_6.PNG");
