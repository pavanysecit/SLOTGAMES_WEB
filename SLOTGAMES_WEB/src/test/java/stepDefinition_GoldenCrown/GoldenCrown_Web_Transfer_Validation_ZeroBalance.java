...
public class GoldenCrown_Web_Transfer_Validation_ZeroBalance {
WebDriver driver;
Screen screen=new Screen();
	...
	public void open_the_Golden_Crown_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_enter_the_amount_as_zero_SRD_and_click_on_Ok_butotn() throws Throwable {
		 ...
		 Screen screen=new Screen();
		 Pattern bal=new Pattern("E:/Sikuli Images/GoldenCrown/zerobalance.png");

		  //Comparing the amount which is transferring to the slot game
	      Pattern credit1=new Pattern("E:/Sikuli Images/GoldenCrown/zerobalance.png");
		  ...
		  System.out.println("Transfer failed and validation message 'Please enter amount greater than zero' is displayed");
		  finder.destroy();  
		  }         
		  else    
		  { 
