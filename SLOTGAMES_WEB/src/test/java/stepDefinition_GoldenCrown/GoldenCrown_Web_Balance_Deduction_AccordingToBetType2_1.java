...
public class GoldenCrown_Web_Balance_Deduction_AccordingToBetType2_1 {
WebDriver driver;
	...
	public void open_the_Golden_Crown_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_value_to_click_on_spin_button_and_check_the_balance(int arg1, int arg2) throws Throwable {
		...
		String path = System.getProperty("user.dir")+"E:\\Sikuli Images\\betValue2_1.PNG";
		Screen screen=new Screen();
		Pattern pat1=new Pattern("E:/Sikuli Images/Bet Values/betValue2_1.png");
        ...
        //comparing the credit value should be 0.02
	     ...
	     Pattern pat=new Pattern("E:/Sikuli Images/Bet Values/balance2_1.png");
