...
public class GoldenCrown_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_2 {
	WebDriver driver;
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count_in_gamble_page(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		//comparing denomination as 0.4  
	     Pattern balance0=new Pattern("E:/Sikuli Images/GoldenCrown/bet1_2.PNG");
		 ...
		 System.out.println("selected denomination is 0.4, comparision successful.");
		 finder0.destroy();  
		 }         
		 else    
		 { 
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/GoldenCrown/win_g1_2_1.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/GoldenCrown/win_g1_2_2.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/GoldenCrown/win_g1_2_3.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/GoldenCrown/win_g1_2_4.PNG");
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/GoldenCrown/win_g1_2_5.PNG");
	    // screen.wait(Win33, 30);
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/GoldenCrown/win_g1_2_6.PNG");
