...
public class SkinfiriJungle_Web_Balance_Check_WinAmount_AddedToBalance {
	WebDriver driver;
	...
	@When("^Open the Golded hot slot game by entering the valid URL in browser, enter the valid login details, transfer the amount, click on spin button till user win and check the balance after win in Skinfiri Jungle slot game$")
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_amount_click_on_spin_button_till_user_win_and_check_the_balance_after_win_in_Skinfiri_Jungle_slot_game() throws Throwable {
		...
		Pattern collect=new Pattern("E:/Sikuli Images/SoccerMania/collect.png");
		...
		//comparing the credit value should be 0.01
		 ...
		 //comparing the win amount should exists after spin
		  ...
		  System.out.println("Win amount comparision after spin completed successfully. Win amount is 11.00.");
		  finder2.destroy();  
		  }         
		  else    
		  { 
	      ...
	      Pattern balanceA=new Pattern("E:/Sikuli Images/SkinfiriJungle/Balance_win_1_1.PNG");
