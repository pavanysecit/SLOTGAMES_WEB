...
public class SkinfiriJungle_Web_Gamble_SuitWinAmount_AddedTo_Balance {
	WebDriver driver;
	...
	public void chrome_browser_valid_URL_valid_login_details_Skinfiri_Jungle_slot_game_balance_spin_button_win_amount_gamble_button_card_to_click_for_suit_win_and_suit_win_amount() throws Throwable {
	...
	public void open_the_Skinfiri_Jungle_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_till_player_wins_click_on_gamble_button_and_click_on_suit_win_card_in_gamble_page() throws Throwable {
		...
		Pattern Win_s_21=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_21.png");
		Pattern Win_s_22=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_22.png");
		Pattern Win_s_23=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_23.png");
		Pattern Win_s_24=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_24.png");
		Pattern Win_s_25=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_25.png");
		...
		Pattern suiticon=new Pattern("E:/Sikuli Images/SkinfiriJungle/suiticon.png");
		 ...
		 //comparing the win amount should exists after spin
	      Pattern winA=new Pattern("E:/Sikuli Images/SkinfiriJungle/win_amount4.PNG");
		  ...
		  System.out.println("Win amount comparision completed successfully. Win amount is 17.00 YSI");
		  finder2.destroy();  
		  }         
		  else    
		  { 
		...
		//comparing the Suit win amount 
	      Pattern winAA=new Pattern("E:/Sikuli Images/SkinfiriJungle/suitwin_amount.PNG");
		  ...
		  System.out.println("Win amount comparision completed successfully. Win amount is 68.00 YSI");
		  finder12.destroy();  
		  }         
		  else    
		  { 
		  ...
		  if  (screen.exists("E:/Sikuli Images/SkinfiriJungle/gamble_win.png") != null)
	      {
			  ...
			  Pattern bal=new Pattern("E:/Sikuli Images/SkinfiriJungle/balance_aftersuitwin.PNG");
	...
	@Then("^Suit Win amount\\((\\d+)x\\) should get added to the main balance after win else it should not get added to main balance in the Skinfiri Jungle slot game$")
	public void suit_Win_amount_x_should_get_added_to_the_main_balance_after_win_else_it_should_not_get_added_to_main_balance_in_the_Skinfiri_Jungle_slot_game(int arg1) throws Throwable {
		Thread.sleep(3000);
		 driver.quit();
	}
}