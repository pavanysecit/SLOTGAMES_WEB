...
public class SkinfiriJungle_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value1 {
	WebDriver driver;
	...
	@When("^Open the (\\d+) Glowing hot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on Skinfiri Jungle slot game, click on spin button till player wins, click on balance, check the win amount and click on balance$")
	public void open_the_Glowing_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Skinfiri_Jungle_slot_game_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance(int arg1) throws Throwable {
		...
		Pattern balanceCr=new Pattern("E:/Sikuli Images/SkinfiriJungle/balance_credits.png");
		Pattern wincr=new Pattern("E:/Sikuli Images/SkinfiriJungle/balance_click1.png");
		 ...
		 //comparing the win amount should exists after spin
	      ...
	      Pattern balanceA=new Pattern("E:/Sikuli Images/SkinfiriJungle/winamount_credits.PNG");
		  ...
		  //Balance in credits 
	      Pattern symbol=new Pattern("E:/Sikuli Images/SkinfiriJungle/balance_credits1_1.PNG");
	      ...
	      Pattern winB=new Pattern("E:/Sikuli Images/SkinfiriJungle/win_amount.PNG");
