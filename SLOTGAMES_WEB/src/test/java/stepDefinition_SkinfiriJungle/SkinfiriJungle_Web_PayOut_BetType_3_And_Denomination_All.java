...
public class SkinfiriJungle_Web_PayOut_BetType_3_And_Denomination_All {
WebDriver driver;
	
	@Given("^Chrome browser, valid URL, valid login details, SKinfiriLotto slot game, icon to open payout table, all symbols, max amount on each symbol like Q, K, (\\d+) n etc, back button, bet type (\\d+)\\.(\\d+) and all denomination values  on web$")
	public void chrome_browser_valid_URL_valid_login_details_SKinfiriLotto_slot_game_icon_to_open_payout_table_all_symbols_max_amount_on_each_symbol_like_Q_K_n_etc_back_button_bet_type_and_all_denomination_values_on_web(int arg1, int arg2, int arg3) throws Throwable {
		this.driver =  SkinfiriJungle_URL_Login.getDriver();
	}

	@When("^Open the SKinfiriLotto slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on icon to open payout table, check payout amount on each symbol like Q, K, (\\d+) n etc, click on back button, select bet type as (\\d+)\\.(\\d+) & all denomination  values and check payout amount on web$")
	public void open_the_SKinfiriLotto_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_icon_to_open_payout_table_check_payout_amount_on_each_symbol_like_Q_K_n_etc_click_on_back_button_select_bet_type_as_all_denomination_values_and_check_payout_amount_on_web(int arg1, int arg2, int arg3) throws Throwable {
		...
		Pattern denomination1=new Pattern("E:/Sikuli Images/SkinfiriJungle/betvalue_3_1.png");
		Pattern denomination2=new Pattern("E:/Sikuli Images/SkinfiriJungle/betvalue_3_2.png");
		Pattern denomination3=new Pattern("E:/Sikuli Images/SkinfiriJungle/betvalue_3_3.png");
		Pattern denomination4=new Pattern("E:/Sikuli Images/SkinfiriJungle/betvalue_3_4.png");
		Pattern denomination5=new Pattern("E:/Sikuli Images/SkinfiriJungle/betvalue_3_5.png");
		...
		Thread.sleep(2000);
         ...
         Pattern pat1=new Pattern("E:/Sikuli Images/SkinfiriJungle/payout3_1.png");
         ...
         Pattern pat2=new Pattern("E:/Sikuli Images/SkinfiriJungle/payout3_2.png");
         ...
         Pattern pat3=new Pattern("E:/Sikuli Images/SkinfiriJungle/payout3_3.png");
        ...
        Pattern pat4=new Pattern("E:/Sikuli Images/SkinfiriJungle/payout3_4.png");
        ...
        Pattern pat5=new Pattern("E:/Sikuli Images/SkinfiriJungle/payout3_5.png");
	...
	@Then("^System should display the Payout max amount on each symbol like Q, K, (\\d+) n etc and payout max amount should get changed whenever player changes the bet type to (\\d+)\\.(\\d+) and all denomination values in SKinfiriLotto slot game on web$")
	public void system_should_display_the_Payout_max_amount_on_each_symbol_like_Q_K_n_etc_and_payout_max_amount_should_get_changed_whenever_player_changes_the_bet_type_to_and_all_denomination_values_in_SKinfiriLotto_slot_game_on_web(int arg1, int arg2, int arg3) throws Throwable {
		 Thread.sleep(3000);
		 driver.quit();
	}
}
