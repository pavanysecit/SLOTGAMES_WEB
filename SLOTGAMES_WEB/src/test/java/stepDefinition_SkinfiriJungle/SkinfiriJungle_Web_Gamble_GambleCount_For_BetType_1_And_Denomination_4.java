...
public class SkinfiriJungle_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_4 {
	WebDriver driver;
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_transfer_the_amount_select_bet_type_as_denomination_as_TWO_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2) throws Throwable {
		...
		Pattern betvalue_1_4=new Pattern("E:/Sikuli Images/SkinfiriJungle/betvalue_1_4.png");
		Pattern collect=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamblecount/gamble_collect.png");
		...
		Pattern Win_s_9=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_9.png");
		Pattern Win_s_10=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_10.png");
		Pattern Win_s_11=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_11.png");
		Pattern Win_s_12=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_12.png");
		Pattern Win_s_13=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_13.png");
		Pattern Win_s_14=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_14.png");
		Pattern Win_s_15=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_15.png");
		Pattern Win_s_16=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_16.png");
		Pattern Win_s_17=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_17.png");
		Pattern Win_s_18=new Pattern("E:/Sikuli Images/SkinfiriJungle/Win_s_18.png");
		Pattern gamble=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamblecount/gamble.png");
		
		//Selecting the bet values as 2
		screen.click(betvalue_1_4);
		Thread.sleep(2000);
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamble_win1111.PNG");
		 ...
		 Thread.sleep(3000);
	      ...
	      Pattern winA=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamblecount/gamblecount1.png");
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamble_win2222.PNG");
		 ...
		 System.out.println("If the win amount is 5.00, gamble count should be 4.");
		 finder11.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing the gamble count based on the win amount
	      Pattern winB=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamblecount/gamblecount2.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamble_win3333.PNG");
		 ...
		 System.out.println("If the win amount is 13.00, gamble count should be 3.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing the gamble count based on the win amount
	      Pattern winBC=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamblecount/gamblecount3.png");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamble_win4444.PNG");
		 ...
		 System.out.println("If the win amount is 22.00, gamble count should be 2.");
		 finder13.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing the gamble count based on the win amount
	      Pattern winBD=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamblecount/gamblecount4.png");
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamble_win5555.PNG");
		 ...
		 System.out.println("If the win amount is 60.00, gamble count should be 1.");
		 finder123.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing the gamble count based on the win amount
	      Pattern winBDC=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamblecount/gamblecount5.png");
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamble_win6666.PNG");
		 ...
		 System.out.println("If the win amount is exceeds 200.00, gamble link should be disabled.");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Assert.assertTrue(score1231 > 90);
		  ...
		  //comparing the gamble count based on the win amount
	      Pattern winBF=new Pattern("E:/Sikuli Images/SkinfiriJungle/gamblecount/gamble_disabled.png");
