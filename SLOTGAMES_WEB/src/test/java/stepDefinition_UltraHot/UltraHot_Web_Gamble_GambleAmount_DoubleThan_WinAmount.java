...
public class UltraHot_Web_Gamble_GambleAmount_DoubleThan_WinAmount {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_to_win_amount() throws Throwable {
		...
		Pattern gambletowin=new Pattern("E:/Sikuli Images/UltraHot/gambletowin.png");  
		...
		Thread.sleep(1000);
		 ...
		 //comparing the Color win amount should be double than as win amount
		  ...
		  System.out.println("Gamble Win amount comparision completed successfully. Gamble Win amount is 80.00 YSI");
		  finder3.destroy();  
		  }         
		  else    
		  { 
