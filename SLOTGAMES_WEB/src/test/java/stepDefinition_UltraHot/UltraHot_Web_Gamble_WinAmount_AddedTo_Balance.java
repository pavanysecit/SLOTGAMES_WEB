...
public class UltraHot_Web_Gamble_WinAmount_AddedTo_Balance {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_spin_button_till_player_wins_click_on_gamble_button_click_on_red_or_black_button_and_check_the_balance_after_win() throws Throwable {
		...
		Pattern red=new Pattern("E:/Sikuli Images/UltraHot/red.png");  
		...
		Thread.sleep(1000);
		 ...
		 //comparing the win amount should exists after spin
		  ...
		  System.out.println("Win amount comparision after Win: "+" "+score2 +"%");
		 ...
		 // Thread.sleep(2000);
		  try{
			    String path1 = "E:/Sikuli Images/UltraHot/gamble.png";
		  ...
		  if  (screen.exists("E:/Sikuli Images/UltraHot/win.png") != null)
	      {
	    	  Pattern gambleStatus=new Pattern("E:/Sikuli Images/UltraHot/win.PNG");
			  ...
			  Pattern bal=new Pattern("E:/Sikuli Images/UltraHot/balance_afterGambleWin.PNG");
	      ...
	      {
	    	  Pattern gambleStatus=new Pattern("E:/Sikuli Images/UltraHot/lose.PNG");
			  ...
			  Pattern Abalance=new Pattern("E:/Sikuli Images/UltraHot/balance_afterGambleLose.PNG");
			  ...
			  System.out.println("Balance After losing in gamble. Balance is 295 YSI");
			  finder11.destroy();  
			  }         
			  else    
			  { 
