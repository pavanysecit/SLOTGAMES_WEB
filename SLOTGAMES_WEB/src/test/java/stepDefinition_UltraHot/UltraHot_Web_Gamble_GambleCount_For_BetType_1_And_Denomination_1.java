...
public class UltraHot_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_1 {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_bet_type_as_denomination_as_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2, int arg3, int arg4) throws Throwable {
	    ...
	    Pattern win_g1_1_1=new Pattern("E:/Sikuli Images/UltraHot/win_g1_1_1.PNG");
	    ...
	    Pattern win_g1_1_2=new Pattern("E:/Sikuli Images/UltraHot/win_g1_1_2.PNG");
	    Pattern win_g1_1_3=new Pattern("E:/Sikuli Images/UltraHot/win_g1_1_3.PNG");
	    Pattern win_g1_1_4=new Pattern("E:/Sikuli Images/UltraHot/win_g1_1_4.PNG");
	    Pattern maxbet=new Pattern("E:/Sikuli Images/UltraHot/maxbet.PNG");
	    Pattern take=new Pattern("E:/Sikuli Images/UltraHot/take.PNG");
	    
		screen.wait(spin, 30);
		
		//comparing denomination as 0.15
		 ...
		 System.out.println("selected Denomination is 0.15, comparision successful.");
		 finder0.destroy();  
		 }         
		 else    
		 { 
		...
		Thread.sleep(1000);
		 ...
		 System.out.println("If the win amount is exceeds 5.25 YSI, gamble link should be disabled. Now win is 6.00 YSI");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
