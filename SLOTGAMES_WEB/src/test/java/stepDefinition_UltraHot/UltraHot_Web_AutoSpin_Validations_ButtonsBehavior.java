...
public class UltraHot_Web_AutoSpin_Validations_ButtonsBehavior {
	WebDriver driver;
	Screen screen=new Screen();
	
	@Given("^Chrome browser, valid URL, valid login details, Ultra Hot slot game, balance, spin button, auto spin button, auto spins option and check for buttons behavior & functionality$")
	public void chrome_browser_valid_URL_valid_login_details_Ultra_Hot_slot_game_balance_spin_button_auto_spin_button_auto_spins_option_and_check_for_buttons_behavior_functionality() throws Throwable {
		this.driver =  UltraHot_Web_URL_Login.getDriver();
	}

	@When("^Open the Ultra Hot slot game by entering the valid URL in browser, enter the valid login details, transfer the balance, click on auto spin option under auto spin drop down and check behavior of different buttons in different scenarios$")
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_auto_spin_option_under_auto_spin_drop_down_and_check_behavior_of_different_buttons_in_different_scenarios() throws Throwable {
		...
		Pattern ahome=new Pattern("E:/Sikuli Images/UltraHot/autoplay_home.png");
		Pattern ainfo=new Pattern("E:/Sikuli Images/UltraHot/autoplay_info.png");
		Pattern acreditvalue=new Pattern("E:/Sikuli Images/UltraHot/autoplay_credit.png");
		Pattern abetvalue=new Pattern("E:/Sikuli Images/UltraHot/autoplay_betvalue.png");
		Pattern astop=new Pattern("E:/Sikuli Images/UltraHot/autoplay_stop.png");
		Pattern betvalue=new Pattern("E:/Sikuli Images/UltraHot/autoplay_betvalue_click.PNG");
		Pattern credit=new Pattern("E:/Sikuli Images/UltraHot/autoplay_creditvalue_click.PNG");
		...
		Pattern payout1_1=new Pattern("E:/Sikuli Images/UltraHot/payout1_1.png");
		Pattern goodluck=new Pattern("E:/Sikuli Images/UltraHot/goodluck.png");
		Pattern placebet=new Pattern("E:/Sikuli Images/UltraHot/placebet.png");
