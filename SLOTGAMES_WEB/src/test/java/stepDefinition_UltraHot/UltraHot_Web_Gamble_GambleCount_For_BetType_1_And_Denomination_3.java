...
public class UltraHot_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_3 {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count_in_gamble_page_of_slot_game(int arg1, int arg2, int arg3, int arg4) throws Throwable {
	    ...
	    Pattern bet1_1=new Pattern("E:/Sikuli Images/UltraHot/bet1_3.PNG");
	    Pattern win_g1_1_1=new Pattern("E:/Sikuli Images/UltraHot/win_g1_3_1.PNG");
	    ...
	    Pattern win_g1_1_2=new Pattern("E:/Sikuli Images/UltraHot/win_g1_3_2.PNG");
	    Pattern win_g1_1_3=new Pattern("E:/Sikuli Images/UltraHot/win_g1_3_3.PNG");
	    Pattern win_g1_1_4=new Pattern("E:/Sikuli Images/UltraHot/win_g1_3_4.PNG");
		...
		//comparing denomination as 0.75
		 ...
		 System.out.println("selected Denomination is 0.75, comparision successful.");
		 finder0.destroy();  
		 }         
		 else    
		 { 
		...
		Thread.sleep(1000);
		 ...
		 System.out.println("If the win amount is 18.00, gamble count should be 1.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 System.out.println("If the win amount is exceeds 26.25 YSI, gamble link should be disabled. Now win is 30.00 YSI");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
