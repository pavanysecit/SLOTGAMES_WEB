...
public class UltraHot_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_4 {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_transfer_the_amount_select_bet_type_as_denomination_as_one_point_five_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2) throws Throwable {
	    ...
	    Pattern bet1_1=new Pattern("E:/Sikuli Images/UltraHot/bet1_4.PNG");
	    Pattern win_g1_1_1=new Pattern("E:/Sikuli Images/UltraHot/win_g1_4_1.PNG");
	    ...
	    Pattern win_g1_1_2=new Pattern("E:/Sikuli Images/UltraHot/win_g1_4_2.PNG");
	    Pattern win_g1_1_3=new Pattern("E:/Sikuli Images/UltraHot/win_g1_4_3.PNG");
	    Pattern win_g1_1_4=new Pattern("E:/Sikuli Images/UltraHot/win_g1_4_4.PNG");
		...
		//comparing denomination as 1.5
		 ...
		 System.out.println("selected Denomination is 1.5, comparision successful.");
		 finder0.destroy();  
		 }         
		 else    
		 { 
		...
		Thread.sleep(1000);
		 ...
		 System.out.println("If the win amount is 36.00, gamble count should be 1.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 System.out.println("If the win amount is exceeds 52.5 YSI, gamble link should be disabled. Now win is 60.00 YSI");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
