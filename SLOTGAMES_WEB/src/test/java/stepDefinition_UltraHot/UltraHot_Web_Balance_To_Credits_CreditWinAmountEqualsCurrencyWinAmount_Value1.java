...
public class UltraHot_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value1 {
	...
	public void open_the_Ultra_Glowing_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_Ultra_Hot_slot_game_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern balance_credits_1=new Pattern("E:/Sikuli Images/UltraHot/balance_credits_1.png");
		Pattern credit_balance_1=new Pattern("E:/Sikuli Images/UltraHot/credit_balance_1.png");
		Pattern win_cr_1=new Pattern("E:/Sikuli Images/UltraHot/win_cr_1.png");
		...
		screen.wait(spin, 50);
		 ...
		 //comparing the credit value should be 0.03
		  ...
		  System.out.println("Credit value is 0.03 & comparision successful.");
		  finder.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Credit value is 0.03 & comparision value equals to: "+" "+score +"%");
		...
		Thread.sleep(1000);
		 ...
		 //comparing the win amount should exists after spin
		  ...
		  System.out.println("Win amount is 1.20 after spin and comparision completed successfully.");
		  finder2.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Win amount is 1.20 & comparision value equal to: "+" "+score2 +"%");
		  ...
		  System.out.println("Balance in credits 9,995 & comparision successfull. ");
		  finder4.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Balance in credits 9,995 & comparision value equal to	: "+" "+score4 +"%");
		  ...
		  System.out.println("Win amount in credits 40 * credit value(0.03) = 1.20 in currnecy & comparision successfull.");
		  finder6.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Win amount in credits 40 * credit value(0.03) = 1.20 in currnecy & comparision value equal to: "+" "+score6 +"%");
