...
public class UltraHot_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_5 {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_three_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2) throws Throwable {
	    ...
	    Pattern bet1_1=new Pattern("E:/Sikuli Images/UltraHot/bet1_5.PNG");
	    Pattern win_g1_1_1=new Pattern("E:/Sikuli Images/UltraHot/win_g1_5_1.PNG");
	    ...
	    Pattern win_g1_1_2=new Pattern("E:/Sikuli Images/UltraHot/win_g1_5_2.PNG");
	    Pattern win_g1_1_3=new Pattern("E:/Sikuli Images/UltraHot/win_g1_5_3.PNG");
	    Pattern win_g1_1_4=new Pattern("E:/Sikuli Images/UltraHot/win_g1_5_4.PNG");
		...
		//comparing denomination as 3
		 ...
		 System.out.println("selected Denomination is 3, comparision successful.");
		 finder0.destroy();  
		 }         
		 else    
		 { 
		...
		Thread.sleep(1000);
		 ...
		 System.out.println("If the win amount is 72.00, gamble count should be 1.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 System.out.println("If the win amount is exceeds 105 YSI, gamble link should be disabled. Now win is 120 YSI");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
