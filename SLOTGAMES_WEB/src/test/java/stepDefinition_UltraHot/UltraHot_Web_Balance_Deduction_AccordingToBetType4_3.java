...
public class UltraHot_Web_Balance_Deduction_AccordingToBetType4_3 {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_ONE_bet_value_as_twenty_five_click_on_spin_button_and_check_the_balance() throws Throwable {
	    ...
	    Pattern balance4_1=new Pattern("E:/Sikuli Images/UltraHot/balance4_3.png");
		...
		Thread.sleep(2000);
	     ...
	     //comparing the credit value should be 1  
	      ...
	      System.out.println("the value of ht"+" "+ht1);
	 	  ...
	 	  System.out.println("After spin, balance is 275.00 & Comparision happened successfully. Test case passed");
	 	  finder1.destroy();  
	 	  }         
	 	  else    
	 	  { 
	 	  ...
	 	  System.out.println("Balance comparision for 275.00 is equals to: "+" "+score1 +"%");
