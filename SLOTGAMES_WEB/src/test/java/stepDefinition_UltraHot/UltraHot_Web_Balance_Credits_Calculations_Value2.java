...
public class UltraHot_Web_Balance_Credits_Calculations_Value2 {
	WebDriver driver;
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_select_the_denomination_from_drop_down_multiply_credit_by_and_check_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern credit2_CR=new Pattern("E:/Sikuli Images/UltraHot/credit2_CR.png");
		Pattern spin=new Pattern("E:/Sikuli Images/UltraHot/spin.png");
		Pattern credit=new Pattern("E:/Sikuli Images/UltraHot/credit.png");
		Pattern credit2=new Pattern("E:/Sikuli Images/UltraHot/credit2.png");	
		
		//selecting credit type as 0.05
		  screen.wait(spin, 30);
		  screen.click(credit);
		  Thread.sleep(2000);
		 ...
		 //comparing the balance in credit
	      ...
	      String ht2 = finder2.find(credit2_CR);
	      double score2=20;                
