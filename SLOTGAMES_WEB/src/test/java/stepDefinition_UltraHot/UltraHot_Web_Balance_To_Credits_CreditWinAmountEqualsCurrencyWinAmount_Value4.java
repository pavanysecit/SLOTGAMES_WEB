...
public class UltraHot_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value4 {
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_the_dinomination_drop_down_value_four_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern balance_credits_1=new Pattern("E:/Sikuli Images/UltraHot/balance_credits_4.png");
		Pattern credit_balance_1=new Pattern("E:/Sikuli Images/UltraHot/credit_balance_4.png");
		Pattern win_1=new Pattern("E:/Sikuli Images/UltraHot/win_4.png");
		...
		Thread.sleep(2000);
		 ...
		 //comparing the credit value should be 1
		  ...
		  System.out.println("Credit value is 1 & comparision successful.");
		  finder.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Credit value is 1 & comparision value equals to: "+" "+score +"%");
		...
		Thread.sleep(1000);
		 ...
		 //comparing the win amount should exists after spin
		  ...
		  System.out.println("Win amount is 40.00 & comparision value equal to: "+" "+score2 +"%");
		  ...
		  System.out.println("Win amount in credits is 295 & comparision value equal to: "+" "+score3 +"%");
		  ...
		  System.out.println("Balance in credits 295 & comparision successfull. ");
		  finder4.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Balance in credits 295 & comparision value equal to	: "+" "+score4 +"%");
		  ...
		  System.out.println("Win amount in credits 40 * credit value(1) = 40 in currnecy & comparision successfull.");
		  finder6.destroy();  
		  }         
		  else    
		  { 
		  ...
		  System.out.println("Win amount in credits 40 * credit value(1) = 40 in currnecy & comparision value equal to: "+" "+score6 +"%");
