...
public class UltraHot_Web_Balance_Credits_Calculations_Value4 {
	WebDriver driver;
	...
	public void open_the_Ultra_Hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_multiply_credit_by_denomination_manually_with_and_check_the_balance(int arg1) throws Throwable {
		...
		Pattern credit4_CR=new Pattern("E:/Sikuli Images/UltraHot/credit4_CR.png");
	    ...
	    Pattern credit4=new Pattern("E:/Sikuli Images/UltraHot/credit4.PNG");
		  ...
		  //changing the credit value to 1
		  Thread.sleep(1000);
		  screen.click(credit);
		  Thread.sleep(1000);
		  screen.click(credit);
		 ...
		 //comparing the balance in credit
	      ...
	      String ht2 = finder2.find(credit4_CR);
	      double score2=20;                
