...
public class SkinfiriLotto_Web_Balance_Credits_Calculations_Value2 {
	WebDriver driver;
	...
	public void open_the_Skinfiri_Lotto_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_balance_select_the_denomination_from_drop_down_multiply_credit_by_and_check_the_balance(int arg1, int arg2) throws Throwable {
		...
		Pattern betvalue_2_3=new Pattern("E:/Sikuli Images/SkinfiriLotto/betvalue_2_3.png");
		...
		Pattern balanceCr=new Pattern("E:/Sikuli Images/SkinfiriLotto/balance_credits1.png");
		Pattern wincr=new Pattern("E:/Sikuli Images/SkinfiriLotto/balance1_4.png");
		 ...
		 Thread.sleep(6000);
	      ...
	      Pattern winA=new Pattern("E:/Sikuli Images/SkinfiriLotto/win_amount1.PNG");
		  ...
		  System.out.println("Win amount comparision after spin completed successfully. Win amount is 3.00");
		  finder2.destroy();  
		  }         
		  else    
		  { 
		  ...
		  //Balance in credits 
	      Pattern symbol=new Pattern("E:/Sikuli Images/SkinfiriLotto/balance_credits1.PNG");
	      ...
	      Pattern winB=new Pattern("E:/Sikuli Images/SkinfiriLotto/win_amount1.PNG");
