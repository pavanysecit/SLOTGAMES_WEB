...
public class SkinfiriLotto_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_3 {
	WebDriver driver;
	...
	public void open_the_Skinfiri_Lotto_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_ONE_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count_in_gamble_page_of_slot_game(int arg1, int arg2) throws Throwable {
		...
		Pattern take=new Pattern("E:/Sikuli Images/SkinfiriLotto/take.png");
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win111.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win222.PNG");
		 ...
		 System.out.println("If the win amount is 4.00, gamble count should be 4.");
		 finder11.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win333.PNG");
		 ...
		 System.out.println("If the win amount is 8.00, gamble count should be 3.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win444.PNG");
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win555.PNG");
		 ...
		 System.out.println("If the win amount is 27.50, gamble count should be 1.");
		 finder123.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win666.PNG");
		 ...
		 System.out.println("If the win amount is exceeds 252.50 YSI, gamble link should be disabled.");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
