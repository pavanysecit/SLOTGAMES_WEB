...
public class SkinfiriLotto_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_5 {
	WebDriver driver;
	...
	public void open_the_Skinfiri_Lotto_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_FOUR_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2) throws Throwable {
		...
		Pattern take=new Pattern("E:/Sikuli Images/SkinfiriLotto/take.png");
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win11111.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win22222.PNG");
		 ...
		 System.out.println("If the win amount is 16.00, gamble count should be 4.");
		 finder11.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win33333.PNG");
		 ...
		 System.out.println("If the win amount is 32.00, gamble count should be 3.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win44444.PNG");
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win55555.PNG");
		 ...
		 System.out.println("If the win amount is 110.00, gamble count should be 1.");
		 finder123.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/SkinfiriLotto/gamble_win66666.PNG");
		 ...
		 System.out.println("If the win amount is exceeds 1010.00 YSI, gamble link should be disabled.");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
