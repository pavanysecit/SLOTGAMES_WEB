...
public class SoccerMania_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_5 {
WebDriver driver;
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_FOUR_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count(int arg1, int arg2) throws Throwable {
		...
		Pattern spin1=new Pattern("E:/Sikuli Images/SoccerMania/betvalue_1_5.png");
		Pattern spin=new Pattern("E:/Sikuli Images/SoccerMania/betvalue_1_55.png");
		...
		Pattern Win_s_9=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_9.png");
		Pattern Win_s_10=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_10.png");
		Pattern Win_s_11=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_11.png");
		Pattern Win_s_12=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_12.png");
		Pattern Win_s_13=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_13.png");
		Pattern Win_s_14=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_14.png");
		Pattern Win_s_15=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_15.png");
		Pattern Win_s_16=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_16.png");
		Pattern Win_s_17=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_17.png");
		Pattern Win_s_18=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_18.png");
		Pattern Win_s_19=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_19.png");
		Pattern Win_s_20=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_20.png");
		Pattern Win_s_21=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_21.png");
		Pattern Win_s_22=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_22.png");
		Pattern Win_s_23=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_23.png");
		Pattern Win_s_31=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_31.png");
		Pattern Win_s_32=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_32.png");
		Pattern Win_s_33=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_33.png");
		Pattern Win_s_34=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_34.png");
		Pattern Win_s_35=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_35.png");
		Pattern Win_s_36=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_36.png");
		Pattern Win_s_37=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_37.png");
		Pattern Win_s_38=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_38.png");
		Pattern Win_s_39=new Pattern("E:/Sikuli Images/SoccerMania/Win_s_39.png");
		Pattern winAmt=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win1.png");
		Pattern win=new Pattern("E:/Sikuli Images/SoccerMania/win_1_1_1.png");
		Pattern gamble=new Pattern("E:/Sikuli Images/SoccerMania/gamble.png");
		Pattern count=new Pattern("E:/Sikuli Images/SoccerMania/gamblecount/gamblecount1.png");
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win11111.PNG");
		 ...
		 System.out.println("If the win amount is 6.00, gamble count should be 5.");
		 finder1.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
	      ...
	      Pattern winA=new Pattern("E:/Sikuli Images/SoccerMania/gamblecount1.png");
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win22222.PNG");
		 ...
		 System.out.println("If the win amount is 26.00, gamble count should be 4.");
		 finder11.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Assert.assertTrue(score11 > 88);
		 
		 screen.click(gamble);
		 Thread.sleep(3000);
		 
		  //comparing the gamble count based on the win amount
	      Pattern winB=new Pattern("E:/Sikuli Images/SoccerMania/gamblecount/gamblecount2.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win33333.PNG");
		 ...
		 System.out.println("If the win amount is 36.00, gamble count should be 3.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing the gamble count based on the win amount
	      Pattern winBC=new Pattern("E:/Sikuli Images/SoccerMania/gamblecount/gamblecount3.png");
		  ...
		  Thread.sleep(1000);
//		  screen.click(Win_s_17);
//		  Thread.sleep(1000);
//		  screen.click(Win_s_18);
//		  Thread.sleep(1000);
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win44444.PNG");
		 ...
		 System.out.println("If the win amount is 58.00, gamble count should be 2.");
		 finder13.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Assert.assertTrue(score13 > 87);
		 
		 screen.click(gamble);
		 Thread.sleep(3000);
		 
		  //comparing the gamble count based on the win amount
	      Pattern winBD=new Pattern("E:/Sikuli Images/SoccerMania/gamblecount/gamblecount4.png");
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win55555.PNG");
		 ...
		 System.out.println("If the win amount is 140.00, gamble count should be 1.");
		 finder123.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing the gamble count based on the win amount
	      Pattern winBDC=new Pattern("E:/Sikuli Images/SoccerMania/gamblecount/gamblecount5.png");
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win66666.PNG");
		 ...
		 System.out.println("If the win amount is exceeds 220.00 YSI, gamble link should be disabled.");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Assert.assertTrue(score1231 > 88);
		 
		 
		  //comparing the gamble count based on the win amount
	      Pattern winBF=new Pattern("E:/Sikuli Images/SoccerMania/gamblecount/gamble_disabled.png");
