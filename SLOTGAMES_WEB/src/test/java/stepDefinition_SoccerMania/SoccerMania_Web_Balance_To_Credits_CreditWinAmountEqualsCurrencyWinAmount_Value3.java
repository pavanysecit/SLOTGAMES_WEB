...
public class SoccerMania_Web_Balance_To_Credits_CreditWinAmountEqualsCurrencyWinAmount_Value3 {
	WebDriver driver;
	...
	public void open_the_Soccer_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_select_the_dinomination_drop_down_value_three_click_on_spin_button_till_player_wins_click_on_balance_check_the_win_amount_and_click_on_balance() throws Throwable {
		...
		Pattern betvalue_3_2=new Pattern("E:/Sikuli Images/SoccerMania/betvalue_3_2.png");
		...
		Pattern balanceCr=new Pattern("E:/Sikuli Images/SoccerMania/balance_credits2.png");
		Pattern wincr=new Pattern("E:/Sikuli Images/SoccerMania/balance_click3.png");
		Pattern creditvalue=new Pattern("E:/Sikuli Images/SoccerMania/creditvalue.png");
		Pattern denom=new Pattern("E:/Sikuli Images/SoccerMania/creditvalue3.png");
		...
		Thread.sleep(2000);
		 ...
		 //comparing the credit value should be 0.05
		  ...
		  System.out.println("Credit value comparision happened successfully. Value is 0.02");
		  finder.destroy();  
		  }         
		  else    
		  { 
		 ...
		 screen.click(betvalue_3_2);
		 Thread.sleep(5000);
		 
		 //comparing the win amount should exists after spin
	      Pattern winA=new Pattern("E:/Sikuli Images/SoccerMania/win_amount4.PNG");
		  ...
		  //Balance in credits 
	      Pattern symbol=new Pattern("E:/Sikuli Images/SoccerMania/balance_credits2.PNG");
	      ...
	      Pattern winB=new Pattern("E:/Sikuli Images/SoccerMania/win_amount5.PNG");
