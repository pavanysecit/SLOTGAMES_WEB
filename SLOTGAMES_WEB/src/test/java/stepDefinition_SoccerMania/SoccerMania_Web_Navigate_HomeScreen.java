...
public class SoccerMania_Web_Navigate_HomeScreen {
	WebDriver driver;
	...
	public void open_the_Soccer_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_and_click_on_home_button() throws Throwable {
		...
		Pattern goldenhot=new Pattern("E:/Sikuli Images/SoccerMania/goldenhot.png");
		Pattern home=new Pattern("E:/Sikuli Images/SoccerMania/home.png");
		Pattern games=new Pattern("E:/Sikuli Images/SoccerMania/games.png");

		 
		  //Comparing whether golden hot game is loaded and home button is visible
	      Pattern credit1=new Pattern("E:/Sikuli Images/SoccerMania/soccermania1.png");
		 ...
		 Thread.sleep(3000);
	      ...
	      Pattern winA=new Pattern("E:/Sikuli Images/SoccerMania/soccermania1.PNG");
