...
public class SoccerMania_Web_Check_MaximizeAndMinimize_Buttons {
	WebDriver driver;
	...
	public void open_the_Soccer_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_maximize_button_and_click_on_minimize_button() throws Throwable {
		...
		Pattern url=new Pattern("E:/Sikuli Images/SoccerMania/url.png");
		Pattern min=new Pattern("E:/Sikuli Images/SoccerMania/minimize.png");
		Pattern max=new Pattern("E:/Sikuli Images/SoccerMania/maximize.png");
		 ...
		 Thread.sleep(6000);
	      ...
	      Pattern credit1=new Pattern("E:/Sikuli Images/SoccerMania/url.png");
		 ...
		 Thread.sleep(5000);
	      ...
	      Pattern winA=new Pattern("E:/Sikuli Images/SoccerMania/url.PNG");
