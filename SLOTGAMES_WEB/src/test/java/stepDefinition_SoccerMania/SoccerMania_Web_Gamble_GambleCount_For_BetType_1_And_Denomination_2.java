...
public class SoccerMania_Web_Gamble_GambleCount_For_BetType_1_And_Denomination_2 {
WebDriver driver;
	...
	public void open_the_Golded_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_golden_hot_slot_game_select_bet_type_as_denomination_as_click_on_spin_button_till_player_wins_click_on_gamble_button_and_check_the_gamble_count_in_gamble_page(int arg1, int arg2, int arg3, int arg4) throws Throwable {
		...
		Pattern spin1=new Pattern("E:/Sikuli Images/SoccerMania/betvalue_1_2.png");
		Pattern spin=new Pattern("E:/Sikuli Images/SoccerMania/betvalue_1_22.png");
		...
		Pattern count=new Pattern("E:/Sikuli Images/SoccerMania/gamblecount/gamblecount1.png");
	     ...
	     Pattern balance=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win11.PNG");
		 ...
		 //comparing gamble count based on win amount
	     Pattern balance1=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win22.PNG");
		 ...
		 System.out.println("If the win amount is 2.60, gamble count should be 4.");
		 finder11.destroy();  
		 }         
		 else    
		 { 
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win3=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win33.PNG");
		 ...
		 System.out.println("If the win amount is 3.60, gamble count should be 3.");
		 finder12.destroy();  
		 }         
		 else    
		 { 
...
//		  Thread.sleep(1000);
		 ...
		 //comparing gamble count based on win amount
	     Pattern Win4=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win44.PNG");
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win33=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win55.PNG");
		 ...
		 System.out.println("If the win amount is 14.00, gamble count should be 1.");
		 finder123.destroy();  
		 }         
		 else    
		 { 
		 ...
		 Thread.sleep(3000);
		  ...
		  //comparing gamble count based on win amount
	     Pattern Win331=new Pattern("E:/Sikuli Images/SoccerMania/gamble_win66.PNG");
		 ...
		 System.out.println("If the win amount is exceeds 22.00 YSI, gamble link should be disabled.");
		 finder1231.destroy();  
		 }         
		 else    
		 { 
