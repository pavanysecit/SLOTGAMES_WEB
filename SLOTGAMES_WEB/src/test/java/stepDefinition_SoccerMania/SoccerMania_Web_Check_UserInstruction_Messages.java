...
public class SoccerMania_Web_Check_UserInstruction_Messages {
WebDriver driver;
	...
	public void open_the_Soccer_Mania_hot_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_transfer_the_balance_click_on_spin_button_and_check_the_user_instruction_messages() throws Throwable {
		...
		Pattern spin=new Pattern("E:/Sikuli Images/SoccerMania/betvalue_1_5.png");
		 
		  //Comparing Place your bet message is displaying
	      Pattern credit1=new Pattern("E:/Sikuli Images/SoccerMania/placebet.png");
		 ...
		 Thread.sleep(1000);
	      ...
	      Pattern winA=new Pattern("E:/Sikuli Images/SoccerMania/goodluck.PNG");
