...
public class SoccerMania_Web_TransferAmount_Verify {
WebDriver driver;
	...
	public void open_the_Soccer_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_click_on_Play_button_enter_the_valid_amount_to_transfer_and_click_on_Ok_butotn() throws Throwable {
	  ...
	  //Comparing the amount which is transferring to the slot game
        Pattern credit1=new Pattern("E:/Sikuli Images/SoccerMania/beforetransfer.png");
		...
		finder.destroy();  
		 ...
		 File sct = driver.findElement(By.xpath("//*[@id='iframeSlotGame']")).getScreenshotAs(OutputType.FILE);
	      ...
	      Pattern winA=new Pattern("E:/Sikuli Images/SoccerMania/balance.PNG");
