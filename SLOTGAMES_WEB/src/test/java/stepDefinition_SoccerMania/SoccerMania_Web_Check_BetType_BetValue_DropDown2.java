...
public class SoccerMania_Web_Check_BetType_BetValue_DropDown2 {
	WebDriver driver;
	...
	public void open_the_Soccer_Mania_slot_game_by_entering_the_valid_URL_in_browser_enter_the_valid_login_details_select_the_bet_type_as_and_check_the_bet_value_should_be(int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) throws Throwable {
		...
		WebElement balT = driver.findElement(By.id("transferInput"));
		  ...
		  Pattern credit=new Pattern("E:/Sikuli Images/SoccerMania/creditvalue1.png");
		  Pattern credit11=new Pattern("E:/Sikuli Images/SoccerMania/creditvalue.png");
        ...
        //comparing the credit value should be 0.02
		 ...
		 Pattern pat=new Pattern("E:/Sikuli Images/SoccerMania/betvalue2.png");
       ...
       if(finder1.hasNext())
		 ...
		 System.out.println("Comparision happened successfully. Available denominations are: 0.6, 1.2, 3, 6 & 12. Test case passed");
		 finder1.destroy();  
		 }         
		 else    
		 { 
